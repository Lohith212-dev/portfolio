    ...
    cards: [
      {
        ...
        note: 'A freelance campaign system for an entrepreneurship platform — one brand, four campaigns, each tuned to a different moment in the funnel.',
        actionType: 'internal-route',
        cover: {
          src: '/images/case-studies/encubate/unstuck-1.webp',
          position: 'center',
        },
        details: {
          template: 'visual-system',
          eyebrow: 'Visual Systems',
          title: 'Encubate — one brand, four campaigns',
          summary: 'Encubate.me helps busy professionals start a business without quitting their jobs. As a freelance campaign designer, I built the campaigns that sold that idea — a flagship launch, two seasonal pushes, and a retargeting wave — each with its own social set and landing page, all speaking one consistent brand.',
          role: 'Campaign & Brand Designer (freelance)',
          year: '2021–2022',
          leadImage: {
            src: '/images/case-studies/encubate/unstuck-1.webp',
            alt: 'Get Unstuck flagship social ad — "Feeling Stuck Starting Your Business?"',
            caption: 'The flagship hook — built to make "I\'m stuck" feel like the start of the fix, not the end of the road.',
          },
          sidebar: {
            categories: ['Branding', 'Campaigns', 'Edtech'],
            responsibilities: [
              'Campaign concept and visual direction',
              'Social collateral for Instagram, LinkedIn & Facebook',
              'Campaign landing-page design',
              'Seasonal re-theming across the full set',
            ],
            facts: [
              { label: 'Role', value: 'Campaign & Brand Designer (freelance)' },
              { label: 'Client', value: 'encubate.me' },
              { label: 'Timeline', value: '2021–2022' },
              { label: 'Status', value: 'Brand acquired by Dailygreatness (2022)' },
            ],
            factsVisibleCount: 4,
            projectDisclaimer: 'Campaign work created on commission for encubate.me. Brand assets remain the property of their owners.',
          },
          sections: [
            {
              id: 'context',
              ...
              thesis: 'One brand, four campaigns — each tuned to a different moment, all speaking the same visual language.',
            },
            {
              id: 'get-unstuck',
              type: 'gallery',
              title: 'Get Unstuck — the flagship',
              navLabel: 'Get Unstuck',
              intro: 'The first commission. The brief was a pain point — getting stuck starting a business — and the design decision was to make that pain as relatable and simple as possible. The more people saw themselves in the problem, the more would feel the value of the fix and sign up. I built the campaign landing page and a social set for Instagram, LinkedIn, and Facebook around that one idea.',
              groups: [
                {
                  label: 'The social set',
                  layout: 'social',
                  items: [
                    { src: '/images/case-studies/encubate/unstuck-1.webp', alt: '"Feeling Stuck Starting Your Business?" social ad.', caption: 'The hook, stated plainly — the problem before the pitch.' },
                    { src: '/images/case-studies/encubate/unstuck-2.webp', alt: '"Struggling to create your business plan?" social ad.', caption: 'A specific stuck-point, with real faces to make it human.' },
                    { src: '/images/case-studies/encubate/unstuck-3.webp', alt: 'Get Unstuck campaign social ad.', caption: 'Same system, next objection — built to scale across the feed.' },
                    { src: '/images/case-studies/encubate/unstuck-4.webp', alt: 'Get Unstuck campaign social ad.', caption: 'One visual language, many messages.' },
                  ],
                },
                {
                  label: 'The campaign page',
                  layout: 'page',
                  items: [
                    { src: '/images/case-studies/encubate/unstuck-page.webp', alt: 'Get Unstuck campaign landing page, full length.', caption: 'The landing page — the pain point up top, then how Encubate gets you unstuck. Click to read it full length.' },
                  ],
                },
              ],
            },
            {
              id: 'seasonal',
              type: 'gallery',
              title: 'Seasonal — Christmas & Black Friday',
              navLabel: 'Seasonal',
              intro: 'When the calendar gave a reason to buy, the message pivoted from product to gift: gifting an entrepreneurship course beats gifting one more object that gathers dust. Each campaign was re-themed to its occasion — Christmas in red-and-white warmth, Black Friday in high-contrast urgency — while the brand stayed recognisable underneath.',
              groups: [
                {
                  label: 'Christmas — gift a course',
                  layout: 'social',
                  items: [
                    { src: '/images/case-studies/encubate/xmas-1.webp', alt: 'Christmas "gift an entrepreneurship course" social ad.', caption: '"Gift an entrepreneurship course" — the seasonal reframe.' },
                    { src: '/images/case-studies/encubate/xmas-2.webp', alt: 'Christmas campaign social ad.', caption: 'Festive theming over the same brand core.' },
                    { src: '/images/case-studies/encubate/xmas-3.webp', alt: 'Christmas campaign social ad.', caption: 'Warm reds and whites carry the offer.' },
                  ],
                },
                {
                  label: 'Black Friday — last-chance urgency',
                  layout: 'social',
                  items: [
                    { src: '/images/case-studies/encubate/bf-1.webp', alt: 'Black Friday deal social ad, 83% off.', caption: 'High-contrast black and red — the urgency the day runs on.' },
                    { src: '/images/case-studies/encubate/bf-2.webp', alt: 'Black Friday campaign social ad.', caption: 'Deal-led, deadline-led — built to convert fast.' },
                  ],
                },
                {
                  label: 'The themed campaign pages',
                  layout: 'page',
                  items: [
                    { src: '/images/case-studies/encubate/xmas-page.webp', alt: 'Christmas deal landing page, full length.', caption: 'Christmas deal page — the offer dressed for the season.' },
                    { src: '/images/case-studies/encubate/bf-page.webp', alt: 'Black Friday deal landing page, full length.', caption: 'Black Friday deal page — same spine, sharper edge.' },
                  ],
                },
              ],
            },
            {
              id: 'retargeting',
              type: 'gallery',
              title: 'Retargeting — editorial scroll-stoppers',
              navLabel: 'Retargeting',
              layout: 'social',
              intro: 'For audiences who had already met the brand, the job changed from explaining to interrupting. This set went editorial — contemporary, art-led visuals built as pattern-breaks in a busy feed rather than offers. The aim was recall: stop the scroll, stay in memory, bring them back.',
              items: [
                { src: '/images/case-studies/encubate/retarget-1.webp', alt: 'Editorial retargeting ad.', caption: 'Art-led, not offer-led — a scroll-stopper.' },
                { src: '/images/case-studies/encubate/retarget-2.webp', alt: 'Editorial retargeting ad — "the next unicorn".', caption: 'The aspiration, made visual.' },
                { src: '/images/case-studies/encubate/retarget-3.webp', alt: 'Editorial retargeting ad.', caption: 'Contemporary styling for a warm audience.' },
                { src: '/images/case-studies/encubate/retarget-4.webp', alt: 'Editorial retargeting ad.', caption: 'A quieter, moodier register than the launch set.' },
                { src: '/images/case-studies/encubate/retarget-5.webp', alt: 'Editorial retargeting ad.', caption: 'Recall over reach — designed to be remembered.' },
                { src: '/images/case-studies/encubate/retarget-6.webp', alt: 'Editorial retargeting ad.', caption: 'Same brand, gallery-grade finish.' },
              ],
            },
            {
              id: 'impact',
              ...
              title: 'Impact',
              navLabel: 'Impact',
              intro: 'A more relatable message pulled more of the right people in — and the campaigns performed.',
              items: [
                { figure: '3.2×', label: 'Return on ad spend' },
                { figure: '100+', label: 'New signups from the flagship' },
                { figure: '2×', label: 'User engagement' },
                { figure: '+18%', label: 'Lift in campaign conversion rate' },
              ],
              note: 'encubate.me was acquired by Dailygreatness in late 2022 and its app now powers their business-building program; figures are the campaigns\' reported results from that period.',
            },
          ],
        },
      },
      {
        slug: 'egmat-sales-deals',
        title: 'e-GMAT Sales Deals',
        tag: 'Conversion collateral',
        note: 'A visual-strategy revamp of e-GMAT\'s sales collateral — from generic stock photos to a system built on real student proof.',
        actionType: 'internal-route',
        cover: {
          src: '/images/case-studies/sales-deals/success-1.webp',
          position: 'center',
        },
        details: {
          template: 'visual-system',
          eyebrow: 'Visual Systems',
          title: 'e-GMAT Sales Deals — from stock photos to proof',
          summary: 'As e-GMAT\'s marketing designer, I rebuilt the visual strategy behind its sales collateral — replacing generic stock-photo ads with a system built on real student proof. One base set, three message lenses, themed per campaign, and extended into the collateral sales used to close students on calls.',
          role: 'Marketing Designer',
          year: '2021–2023',
          leadImage: {
            src: '/images/case-studies/sales-deals/success-2.webp',
            alt: 'Revamped success-focused sales creative — real students and their GMAT score jumps.',
            caption: 'The revamped look: real students, real score jumps — proof a skeptical buyer can believe.',
          },
          sidebar: {
            categories: ['Branding', 'Marketing', 'Edtech'],
            responsibilities: [
              'Visual strategy for sales collateral, with the sales team',
              'A reusable base set, re-themed per campaign',
              'Email, social, and ad creatives across three message lenses',
              'Campaign landing pages and call-closing collateral',
            ],
            facts: [
              { label: 'Role', value: 'Marketing Designer' },
              { label: 'Company', value: 'e-GMAT' },
            ...
            projectDisclaimer: 'Collateral created for e-GMAT. Student photos, scores, and brand assets remain the property of e-GMAT and the respective students.',
          },
          sections: [
            {
              id: 'context',
              ...
              thesis: 'A sales creative has one job: give a skeptical buyer a reason to believe. Stock photos don\'t.',
            },
            {
              id: 'shift',
              type: 'compare',
              title: 'The shift — real students, real proof',
              navLabel: 'The shift',
              intro: 'I worked with the sales team to rebuild the strategy around one decision: drop stock imagery and put real students at the centre — real faces, real score jumps, presented as testament to results we were actually delivering. Drag the slider to compare the old approach with the revamp.',
              before: {
                src: '/images/case-studies/sales-deals/old-1.webp',
                alt: 'Original stock-photo sales ad with a single headshot and a headline.',
                label: 'Old',
              },
              after: {
                src: '/images/case-studies/sales-deals/success-1.webp',
                alt: 'Revamped sales ad showing three real students and their score gains.',
                label: 'New',
              },
              ariaLabel: 'Before-and-after comparison of an e-GMAT sales creative',
              caption: 'Same offer, opposite credibility — a stock headshot becomes real students and the exact days their scores took.',
            },
            {
              id: 'lenses',
              type: 'gallery',
              title: 'Three lenses to communicate value',
              navLabel: 'Three lenses',
              intro: 'From there I built one base set and themed it per campaign — but every creative led with one of three strategic lenses, chosen by what would move that particular buyer.',
              groups: [
                {
                  label: 'Offering-focused — what you get',
                  intro: 'Lead with the deal itself: the price, the inclusions, the deadline. Best when intent is already high and the buyer just needs the terms.',
                  layout: 'wide',
                  items: [
                    { src: '/images/case-studies/sales-deals/offering-1.webp', alt: 'New Year deal creative — lowest price, $89.', caption: 'A seasonal offer, deal-led — price and deadline up front.' },
                    { src: '/images/case-studies/sales-deals/offering-2.webp', alt: 'Offering-focused creative listing course inclusions and price.', caption: 'The full offer, laid out — inclusions and price in one place.' },
                    { src: '/images/case-studies/sales-deals/offering-3.webp', alt: 'Offering-focused ad creative.', caption: 'Same lens, different placement.' },
                    { src: '/images/case-studies/sales-deals/offering-4.webp', alt: 'Offering-focused event-bar creative.', caption: 'An on-site event bar carrying the deal.' },
                    { src: '/images/case-studies/sales-deals/offering-5.webp', alt: 'Themed offering creative.', caption: 'Re-themed for the campaign, same offer logic.' },
                  ],
                },
                {
                  label: 'Stats-focused — proof of leadership',
                  intro: 'Lead with numbers that prove e-GMAT leads the category — reported success rates, top ratings, scale. Best for the buyer comparing options.',
                  layout: 'wide',
                  items: [
                    { src: '/images/case-studies/sales-deals/stats-1.webp', alt: 'Record-success creative with reported success rates from GMAT Club and Reddit.', caption: '#Record Success — reported success rates, sourced and specific.' },
                    { src: '/images/case-studies/sales-deals/stats-2.webp', alt: '2X success at half the price stats creative.', caption: 'A value claim, backed by the numbers beside it.' },
                    { src: '/images/case-studies/sales-deals/stats-3.webp', alt: 'Stats-focused ad creative.', caption: 'Leadership stated as evidence, not adjectives.' },
                    { src: '/images/case-studies/sales-deals/stats-4.webp', alt: 'Stats-focused community-post creative.', caption: 'The same proof, sized for a community post.' },
                  ],
                },
                {
                  label: 'Success-focused — real outcomes',
                  intro: 'Lead with student outcomes: low-to-high score jumps, 100th-percentile starts, fast turnarounds. Best for the buyer who needs to see someone like them succeed.',
                  layout: 'wide',
                  items: [
                    { src: '/images/case-studies/sales-deals/success-3.webp', alt: 'Success creative — 100th percentile from different starting points.', caption: '100th percentile, from any starting point.' },
                    { src: '/images/case-studies/sales-deals/success-4.webp', alt: 'Success creative — ISB admits.', caption: 'Outcomes beyond the score — admits students recognise.' },
                    { src: '/images/case-studies/sales-deals/success-5.webp', alt: 'Individual student success story creative.', caption: 'One student, one story — a face and a journey.' },
                    { src: '/images/case-studies/sales-deals/success-6.webp', alt: 'Individual student success story creative.', caption: 'Proof scaled to the individual.' },
                  ],
                },
              ],
            },
            {
              id: 'pages',
              type: 'gallery',
              title: 'Themed campaign pages',
              navLabel: 'Campaign pages',
              intro: 'For bigger pushes the deal got its own landing page — the same structure re-themed to the occasion, so a Christmas and a New Year campaign felt distinct but unmistakably e-GMAT. Click either to read it full length.',
              layout: 'page',
              items: [
                { src: '/images/case-studies/sales-deals/page-xmas.webp', alt: 'Christmas deal landing page, full length.', caption: 'Christmas deal page — the offer dressed for the season.' },
                { src: '/images/case-studies/sales-deals/page-ny.webp', alt: 'New Year deal landing page, full length.', caption: 'New Year deal page — same spine, new theme.' },
              ],
            },
            {
              id: 'calls',
              type: 'video',
              title: 'Collateral that closed the call',
              navLabel: 'Closing the call',
              intro: 'Some students were interested but never checked out — they needed a human nudge. I built the collateral sales used on those calls: PDF one-pagers that laid out the offer and the success stories, and a 20-minute explainer video sent as the post-call follow-up, so the pitch kept working after the call ended.',
              embedUrl: 'https://www.youtube.com/embed/QuFFTOwzLDE',
              videoTitle: 'e-GMAT offer walkthrough',
              note: 'Video produced for e-GMAT and used here as supporting context; I don\'t own the copyright — all credits to e-GMAT.',
            },
            {
              id: 'impact',
              type: 'stats',
              title: 'Impact',
              navLabel: 'Impact',
              intro: 'The refresh paid off where it mattered — the same audience, more of them convinced.',
              items: [
                { figure: '2×', label: 'Conversions through email' },
                { figure: '1.5×', label: 'Conversions on sales calls' },
                { figure: '+30%', label: 'Students opting into a call' },
              ],
            },
          ],
        },
...
export function getMoreWorkDetailContent(item) {
  ...
  return {
    ...
    // Visual-systems lane (template: 'visual-system'): an ordered array of
    // typed body blocks, plus an optional lead creative under the hero.
    sections: details.sections || [],
    leadImage: details.leadImage || null,
  };
}
